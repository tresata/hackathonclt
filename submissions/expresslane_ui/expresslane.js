...
app.controller('MainController', function ($rootScope, $scope, analytics, $http, $q) {
    $scope.customer = {number: "3b38638f-3a47-4228-bc2f-9ef7a784b637"};

    $scope.items = [
        {name:"Taco Shells", url:"http://slave03.hackathonclt.org:8000/engines/itemrec/EL-Recommendation/topn.json?pio_appkey=NUY1xbHHNEkpaBlcM9CwY2e3L1GoZLXRrZFB6fqE5HMhhYHvhSLf3coSkHsUET2A&pio_uid=3b38638f-3a47-4228-bc2f-9ef7a784b637&pio_n=10&pio_itypes=WINE"}
    ]

    $scope.wines = [
        {name:"SANTI VALPOLICELLA"},
        {name:"SEPTIMA MALBEC"}
    ]

    $scope.showWines = function () {
        $scope.showwines = true;
     }

    $scope.getRecommendation = function (url) {
